...
bot.on('ready', () => {
    ...
    avatar = "https://www.jeuxvideo-live.com/images/news/illustrations/shadow-nos-impressions-sur-le-pc-du-futur-creeee-par-des-franecais-82587-carre.jpg"
    bot.user.setAvatar(avatar);
    bot.user.setUsername('Sнαđow™',"")
});
 
bot.on("ready", () => {
 
  bot.user.setGame(`_help | 18568 serveurs`, 'https://www.twitch.tv/Shadow');
});
